...
if (-not(Test-Path -Path "C:\Program Files\Zulu\zulu-17\bin\java.exe")) {
    ...
    $download = (Invoke-WebRequest -Uri $url | Select-Object -ExpandProperty Links | Where-Object {$_.href -like "zulu17*-ca-jdk*-win_x64.msi"} | Select-Object -First 1).href
...
$microg = Get-LatestVersion -Repo "TeamVanced/VancedMicroG" -File "microg.apk" -Stable
$cli = Get-LatestVersion -Repo "revanced/revanced-cli" -File "revanced-cli*" -Stable
$patches = Get-LatestVersion -Repo "revanced/revanced-patches" -File "revanced-patches*" -Stable
$integrations = Get-LatestVersion -Repo "revanced/revanced-integrations" -File "revanced-integrations*" -Stable
...
$download = (Invoke-WebRequest -Uri $url -Headers $headers -UseBasicParsing | Select-Object -ExpandProperty Links | Where-Object {($_."data-dt-version" -eq $version) -and ($_."data-dt-variant" -eq $false)}).href
